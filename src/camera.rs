...
pub fn camera_follow_system(
    ...
    followed_by_camera_query: Query<&Transform, (With<FollowedByCamera>, Without<Camera>, Without<FollowEntity>)>,
) {
    for mut camera_transform in camera_query.iter_mut() {
        match followed_by_camera_query.get_single() {
            ...
            Err(e) => panic!("There is not exactly one entity with FollowedByCamera component: {}", e),
        }
    }
}
